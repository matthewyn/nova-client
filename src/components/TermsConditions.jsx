  ...
  return (
    <>
      <p className="mb-8">
        ...
        menggunakan Nova AI. Dengan membuat akun, mengakses, atau menggunakan
        layanan Nova AI, Anda menyatakan telah membaca, memahami, dan menyetujui
        seluruh ketentuan yang tercantum dalam dokumen ini.
      </p>
      <h2 className="text-2xl font-semibold mb-2">Definisi</h2>
      <p className="mb-4">
        <span className="font-bold">Nova AI</span> adalah platform analisis
        investasi berbasis data dan kecerdasan buatan yang menyediakan insight,
        forecasting, risk modeling, scenario analysis, dan fitur pendukung
      ...
      <p className="mb-4">
        <span className="font-bold">Insight</span> adalah hasil analisis yang
        dihasilkan oleh model Nova AI berdasarkan data historis, statistik,
        machine learning, dan parameter sistem yang digunakan pada saat analisis
        dilakukan.
      </p>
      <p className="mb-8">
        <span className="font-bold">Akun</span> adalah identitas pengguna yang
        digunakan untuk mengakses layanan Nova AI.
      </p>
      ...
      <p className="mb-8">
        Seluruh informasi yang tersedia pada platform bersifat informatif dan
        edukatif.
      </p>
      <h2 className="text-2xl font-semibold mb-2">Bukan Nasihat Investasi</h2>
      <p className="mb-4">
      ...
      <p className="mb-8">
        Pengguna memahami bahwa seluruh keputusan investasi sepenuhnya merupakan
      ...
      <p className="mb-8">
        Nova AI tidak menjamin keuntungan, profit tertentu, tingkat keberhasilan
        tertentu, ataupun hasil investasi tertentu. Kinerja historis tidak
        menjamin hasil di masa mendatang.
      </p>
      <h2 className="text-2xl font-semibold mb-2">
        Akurasi dan Keterbatasan Sistem
      </h2>
      <p className="mb-4">
        Nova AI menggunakan data, algoritma, model statistik, machine learning,
        dan sumber informasi pihak ketiga yang dapat mengalami:
      </p>
      <ul className="list-disc list-inside mb-4">
      ...
      <p className="mb-8">
        Pengguna memahami bahwa hasil analisis yang ditampilkan dapat berubah
        sewaktu-waktu dan tidak selalu mencerminkan kondisi pasar yang
        sebenarnya. Nova AI tidak menjamin akurasi, kelengkapan, atau kesesuaian
      ...
      <p className="mb-8">
        ...
        login. Seluruh aktivitas yang dilakukan melalui akun pengguna dianggap
        dilakukan oleh pemilik akun tersebut. Nova AI berhak menangguhkan atau
        menghentikan akun yang melanggar ketentuan penggunaan.
      </p>
      ...
      <p className="mb-8">
        ...
        berbayar. Dengan melakukan pembayaran, pengguna menyetujui biaya yang
        berlaku pada saat transaksi dilakukan. Nova AI berhak mengubah harga
        langganan sewaktu-waktu untuk periode berlangganan berikutnya.
      </p>
      ...
      <p className="mb-8">
        Permohonan refund harus diajukan paling lambat 7 (tujuh) hari setelah
        transaksi dilakukan.
      </p>
      <h2 className="text-2xl font-semibold mb-2">Penggunaan yang Dilarang</h2>
      <p className="mb-4">Pengguna dilarang:</p>
      <ul className="list-disc list-inside mb-4">
        <li>Menjual kembali akses Nova AI.</li>
        <li>
          Menyebarkan, menjual kembali, mempublikasikan, atau membagikan insight
          Nova AI kepada pihak ketiga dalam bentuk apapun.
        </li>
        <li>Menggunakan layanan untuk aktivitas yang melanggar hukum.</li>
        <li>
          Mereproduksi, menggandakan, menyalin, atau menjual kembali bagian mana
          pun dari Layanan pada Website KAMI.
        </li>
      </ul>
      <p className="mb-8">
        Setiap insight diberi watermark unik untuk melacak kebocoran.
        Pelanggaran akan dikenakan sanksi berupa pemutusan akses tanpa
        pengembalian biaya dan/atau tuntutan ganti rugi sesuai perjanjian
        terpisah.
      </p>
      <h2 className="text-2xl font-semibold mb-2">Hak Kekayaan Intelektual</h2>
      ...
      <h2 className="text-2xl font-semibold mb-2">Batasan Tanggung Jawab</h2>
      <p className="mb-4">
      ...
      <p className="mb-8">
        Tanggung jawab maksimum Nova AI kepada pengguna, apabila ada, dibatasi
        sebesar total biaya langganan yang telah dibayarkan pengguna dalam 12
        bulan terakhir.
      </p>
      <h2 className="text-2xl font-semibold mb-2">
      ...
      <p className="mb-8">
        ...
        Perubahan akan diumumkan melalui website atau sarana komunikasi resmi
        lainnya. Penggunaan layanan secara berkelanjutan setelah perubahan
        dilakukan dianggap sebagai persetujuan terhadap ketentuan yang
        diperbarui.
      </p>
      ...
      <p className="mb-8">
        ...
        terlebih dahulu secara musyawarah. Apabila tidak tercapai penyelesaian,
        sengketa akan diselesaikan melalui pengadilan yang berwenang sesuai
      ...
      <p className="mb-4">
        ...
        menyatakan telah membaca, memahami, dan menyetujui seluruh isi Syarat
        dan Ketentuan ini.
      </p>
    </>
  );
