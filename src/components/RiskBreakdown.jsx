        ...
        <div className="grid grid-cols-3 gap-4">
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="p-4 relative z-10">
              <h3 className="text-lg font-semibold mb-2">Resiko Keseluruhan</h3>
              <Progress
              ...
              <p className="text-xs text-gray-500">
                Gambaran umum tingkat risiko berdasarkan kombinasi volatilitas,
                momentum, tren, berita, dan likuiditas saham.
              </p>
            </CardContent>
          </Card>
          <Card className="relative overflow-hidden">
            <DotGrid />
            <CardContent className="p-4 relative z-10">
              <h3 className="text-lg font-semibold mb-2">Risiko Volatilitas</h3>
              <Progress
          ...
          <Card className="relative overflow-hidden">
            <DotGrid />
            <CardContent className="p-4 relative z-10">
              <h3 className="text-lg font-semibold mb-2">Resiko Momentum</h3>
              <Progress
          ...
          <Card className="relative overflow-hidden">
            <DotGrid />
            <CardContent className="p-4 relative z-10">
              <h3 className="text-lg font-semibold mb-2">Resiko Trend</h3>
              <Progress
              ...
              <p className="text-xs text-gray-500">
                ...
                harga mulai menunjukkan tanda-tanda pelemahan terhadap arah tren
          ...
          <Card className="relative overflow-hidden">
            <DotGrid />
            <CardContent className="p-4 relative z-10">
              <h3 className="text-lg font-semibold mb-2">Resiko Berita</h3>
              <Progress
          ...
          <Card className="relative overflow-hidden">
            <DotGrid />
            <CardContent className="p-4 relative z-10">
              <h3 className="text-lg font-semibold mb-2">Resiko Likuiditas</h3>
              <Progress
              ...
              <p className="text-xs text-gray-500">
                Mengukur kemudahan masuk dan keluar posisi berdasarkan aktivitas
                transaksi saham. Likuiditas rendah dapat membuat harga lebih
